...
def process_and_save_params(source_folder, output_folder):
    index = 0
...
source_folder = "H:\\INR\\logs\\Compress_multi4D_cart"
output_folder = "H:\\INR\\logs\\Compress_multi4D_cart\\residual"
process_and_save_params(source_folder, output_folder)